...
"""
this class represent a operator (@ipMatch) and this class contain the function that should run when this 
...
this operator check if the ip match to the ip in the field in the places list(the places that the rule ask to  look for)
most of the time it is the remote_addr
"""
class ipMatch_Operator:
    def __init__(self):
        pass
    """
