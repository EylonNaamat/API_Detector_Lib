...
"""
this class represent a operator (@PM) and this class contain the function that should run when this 
...
this operator check if the expression is in the field in the places list(the places that the rule ask to  look for)
